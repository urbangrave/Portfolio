        ...
        <Row className="align-items-center text-center">
          <Col className="d-none d-md-block">
            <div className="intro-text">
                <h1 className="mb-3" style={{ fontSize: '2.5rem' }}>Hello! Welcome to my Portfolio</h1>
                <p className="lead" style={{ fontSize: '1.5rem' }}>
                  I am a full-stack developer with 5 years of freelance experience in PHP and 3 years of solid experience in React.js. I am always seeking more challenging projects to continue enhancing my capabilities as a web developer.
                </p>
